  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <svg
          className={`stroke-gray-500 dark:stroke-gray-400 transition-transform duration-200 shrink-0 ${
            isOpen ? "rotate-180" : ""
          }`}
          width="18"
          height="20"
      ...
      >
        ...
        <button
          ...
          disabled={loggingOut}
          className="flex w-full items-center gap-3 px-3 py-2 mt-3 font-medium text-gray-700 rounded-lg text-theme-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300 disabled:opacity-50 text-left"
        >
          <svg
            className="fill-gray-500 group-hover:fill-gray-700 dark:group-hover:fill-gray-300 shrink-0"
            width="24"
            height="24"
            viewBox="0 0 24 24"
            fill="none"
